...
import com.example.yj.mapapp.adapter.HardSuperDetailAdapter;
 ...
 * 五金超市详情
 */
public class HardSuperDetailActivity extends Activity implements AbsListView.OnScrollListener, View.OnClickListener {

    //下拉刷新
    private ImageView iv_back;//返回
    private List<HardSuper> mData;//五金超市对象集合
    private MListView lv;//自定义的ListView控件
    private HardSuperDetailAdapter adapter;//五金超市ListView控件的适配器
    //下拉加载
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_super_detail);
        ...
        tv_title = (TextView) findViewById(R.id.hard_super_detail_title);
...
//                lv.onRefreshComplete();
        ...
        adapter = new HardSuperDetailAdapter(mData, this);//适配器实例化
    ...
    private void getLabourAgencyInformation(int parentId, int pageIndex, int pageSize, String search) {
        try {
            ...
            RequestHandle post = HTTPTool.getClient().post(HardSuperDetailActivity.this, url, stringEntity, "application/json", new JsonHttpResponseHandler() {
                @Override
...
//                        lv.onRefreshComplete();
                ...
                public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                    ...
                    ToastUtil.longT(HardSuperDetailActivity.this, getText(R.string.hard_super_fail).toString());
