...
public class GsonUtils {
    ...
    public static String toJson(Object target, Type targetType,
        ...
        try {
            ...
            Log.w("GsonUtils","目标对象 " + target.getClass().getName()
                    + " 转换 JSON 字符串时，发生异常！"+ex.getMessage().toString());
    ...
    public static <T> T fromJson(String json, TypeToken<T> token,
        ...
        try {
            ...
            Log.e("GsonUtils",json + " 无法转换为 " + token.getRawType().getName() + " 对象!"+
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
        ...
        try {
            ...
            Log.e("GsonUtils",json + " 无法转换为 " + clazz.getName() + " 对象!"+ex.getMessage().toString());
            return null;
        }
    }
